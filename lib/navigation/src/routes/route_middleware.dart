...
abstract class _RouteMiddleware {
  ...
  /// ```
  /// {@end-tool}
  FlowerPage? onPageCalled(FlowerPage page);
  ...
  FlowerPageBuilder? onPageBuildStart(FlowerPageBuilder page);
...
class FlowerMiddleware implements _RouteMiddleware {
  @override
  int? priority = 0;

  FlowerMiddleware({this.priority});

  @override
  RouteSettings? redirect(String? route) => null;

  @override
  FlowerPage? onPageCalled(FlowerPage? page) => page;

  @override
  List<R>? onBindingsStart<R>(List<R>? bindings) => bindings;

  @override
  FlowerPageBuilder? onPageBuildStart(FlowerPageBuilder? page) => page;
...
class MiddlewareRunner {
  ...
  FlowerPage? runOnPageCalled(FlowerPage? page) {
  ...
  FlowerPageBuilder? runOnPageBuildStart(FlowerPageBuilder? page) {
    _getMiddlewares().forEach((element) {
...
class PageRedirect {
  ...
  bool needRecheck(BuildContext context) {
    ...
    Flower.parameters = match.parameters;
  ...
  void addPageParameter(FlowerPage route) {
    if (route.parameters == null) return;

    final parameters = Map<String, String?>.from(Flower.parameters);
