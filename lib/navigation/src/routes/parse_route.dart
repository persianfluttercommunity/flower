...
class RouteDecoder {
  ...
  final List<FlowerPage> currentTreeBranch;
...
class ParseRouteTree {
  ...
  void addRoutes<T>(List<FlowerPage<T>> getPages) {
    for (final route in getPages) {
      addRoute(route);
    }
  }

  void removeRoutes<T>(List<FlowerPage<T>> getPages) {
    for (final route in getPages) {
      removeRoute(route);
    }
  }

  void removeRoute<T>(FlowerPage<T> route) {
    routes.remove(route);
  ...
  void addRoute<T>(FlowerPage<T> route) {
    routes.add(route);
  ...
  List<FlowerPage> _flattenPage(FlowerPage route) {
    final result = <FlowerPage>[];
  ...
  FlowerPage _addChild(FlowerPage origin, String parentPath,
  ...
  FlowerPage? _findRoute(String name) {
