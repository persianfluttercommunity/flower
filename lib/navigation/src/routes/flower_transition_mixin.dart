...
mixin FlowerPageRouteTransitionMixin<T> on PageRoute<T> {
...
Cannot read the previousTitle for a route that has not yet been installed''',
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    // fullscreen dialog.
    return (nextRoute is FlowerPageRouteTransitionMixin &&
  ...
  static Widget buildPageTransitions<T>(
    ...
    final route = rawRoute as FlowerPageRoute<T>;
    final linearTransition =
        CupertinoRouteTransitionMixin.isPopGestureInProgress(route);
    final finalCurve = route.curve ?? Flower.defaultTransitionCurve;
    ...
    if (route.fullscreenDialog && route.transition == null) {
      ...
      switch (route.transition ?? Flower.defaultTransition) {
        ...
        default:
          final customTransition =
              context.get<FlowerController>().customTransition;
  ...
  static bool _isPopGestureEnabled<T>(
    ...
    if (FlowerPageRouteTransitionMixin.isPopGestureInProgress(context)) {
      return false;
    }
