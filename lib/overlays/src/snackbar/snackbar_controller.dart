...
class SnackbarController {
  ...
  void _configureOverlay() {
    final overlayContext = Flower.overlayContext;
    _isTesting = overlayContext == null;
    _overlayState =
        _isTesting ? OverlayState() : Overlay.of(Flower.overlayContext!);
