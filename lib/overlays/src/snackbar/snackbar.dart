...
typedef OnTap = void Function(FlowerSnackBar snack);

typedef SnackbarStatusCallback = void Function(SnackbarStatus? status);

class FlowerSnackBar extends StatefulWidget {
  ...
  @override
  State createState() => FlowerSnackBarState();

  /// Show the snack. It's call [SnackbarStatus.OPENING] state
  /// followed by [SnackbarStatus.OPEN]
  SnackbarController show() {
    return Flower.showSnackbar(this);
  }
}

class FlowerSnackBarState extends State<FlowerSnackBar>
